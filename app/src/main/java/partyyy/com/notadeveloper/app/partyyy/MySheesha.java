...
public class MySheesha {
    ...
    public MySheesha(String orderid, String orderdate, String amount, String status, ArrayList<String> flavours, String deliverby, String add1, String add2, String addpin, String phone, String name, String noofpots) {
